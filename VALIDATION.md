...
- Obecne: 18 plików źródłowych aplikacji i 15 metod XCTest.
- OK: struktura kopii roboczej GPS jest kodowalna, a zapis końcowy usuwa ją
  dopiero po udanym zapisie modelu.
- OK: rozliczenie trasy zapisuje identyfikator trasy, jej pojazd i aktywną
  zmianę w przychodzie; usunięcie przychodu przywraca stan „Do rozliczenia”.
- OK: nowe pola SwiftData są opcjonalne, dzięki czemu starsze wpisy nie dostają
  sztucznie statusu zaległego rozliczenia.
